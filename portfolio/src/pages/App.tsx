...
function App() {
  ...
  return (
    <>
      ...
      <div className="md:sml-20 md:mt-10 flex flex-col md:flex-row">
        <span className="md:w-1/2 md:mr-10">
          <header>
            <h1 className="text-4xl md:text-8xl pt-10 pl-5 md:pl-20 pb-5 font-sans text-blue-100">Vincent Liu</h1>
          </header>
          ...
          <ul className="pl-10 pr-10 md:pl-24 pt-10 font-sans list-disc text-blue-100">
            ...
            <hr className="border-t-2 border-blue-100 mt-10 md:ml-20 md:mr-10"></hr>
          ...
          <p className="font-mono text-sm md:text-bsae pl-5 pr-5 md:pl-20 w-full text-blue-100">
            ...
            In my spare time, I enjoy playing video games (especially role-playing games), playing the guitar, drumming, and diving into topics such as urban. <br></br> <br></br>
          </p>
        </span>
        <img className="size-full md:size-1/4 md:m-10 md:ml-44" src={image} alt="Vincent Liu" style={{ borderRadius: '20px' }} />
      </div>
    </>
  )
}
